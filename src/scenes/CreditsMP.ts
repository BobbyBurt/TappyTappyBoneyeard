...
export default class CreditsMP extends Phaser.Scene {
	...
	editorCreate(): void {
		...
		// bitmaptext_9
		const bitmaptext_9 = this.add.bitmapText(22, 1709, "nokia", "Bobo");
		...
		// bitmaptext_10
		const bitmaptext_10 = this.add.bitmapText(144, 1712, "nokia", "Level design:");
		...
		// bitmaptext_11
		const bitmaptext_11 = this.add.bitmapText(150, 1724, "nokia", "\"Tina's Tower\"\n\"The Perplex Plan\"\n\"Like a Dickcissel\"");
		...
		// frame_1
		const frame_1 = this.add.rectangle(241, 1619, 500, 134);
		frame_1.isStroked = true;
		frame_1.strokeColor = 5388102;
		frame_1.lineWidth = 3;

		// preview_1
		this.add.image(241, 1619, "preview-The Perplex Plan");

		// bitmaptext_7
		const bitmaptext_7 = this.add.bitmapText(257, 1724, "nokia", "\"ifone stor\"\n\"Fruity\"");
		...
		// bitmaptext_8
		const bitmaptext_8 = this.add.bitmapText(22, 1923, "nokia", "Paytonio");
		...
		// bitmaptext_12
		const bitmaptext_12 = this.add.bitmapText(223, 1926, "nokia", "Level design:");
		...
		// bitmaptext_13
		const bitmaptext_13 = this.add.bitmapText(229, 1938, "nokia", "\"Demolition Bird Squad\"\n\"John Tappington\"\n\"Mad Chicks\"\n\"Tweet Towers\"");
		...
		// frame_2
		const frame_2 = this.add.rectangle(241, 1837, 500, 134);
		frame_2.isStroked = true;
		frame_2.strokeColor = 5388102;
		frame_2.lineWidth = 3;

		// preview_2
		this.add.image(241, 1837, "preview-MadChicks");

		// bitmaptext_14
		const bitmaptext_14 = this.add.bitmapText(359, 1938, "nokia", "\"Fully Rested\"\n\"Playground\"\n\"A Side\"");
		...
		// bitmaptext_15
		const bitmaptext_15 = this.add.bitmapText(22, 2144, "nokia", "STANN.co");
		...
		// bitmaptext_16
		const bitmaptext_16 = this.add.bitmapText(223, 2147, "nokia", "Level design:");
		...
		// bitmaptext_17
		const bitmaptext_17 = this.add.bitmapText(229, 2159, "nokia", "\"The Book of Mormon - Abridged\"");
		...
		// frame_3
		const frame_3 = this.add.rectangle(241, 2064, 500, 134);
		frame_3.isStroked = true;
		frame_3.strokeColor = 5388102;
		frame_3.lineWidth = 3;

		// preview_3
		this.add.image(241, 2064, "preview-stann");

		// bitmaptext_18
		const bitmaptext_18 = this.add.bitmapText(22, 2348, "nokia", "Starturbo");
		...
		// bitmaptext_19
		const bitmaptext_19 = this.add.bitmapText(223, 2351, "nokia", "Level design:");
		...
		// bitmaptext_20
		const bitmaptext_20 = this.add.bitmapText(229, 2363, "nokia", "\"Flipping The Bird\"");
		...
		// frame_4
		const frame_4 = this.add.rectangle(241, 2268, 500, 134);
		frame_4.isStroked = true;
		frame_4.strokeColor = 5388102;
		frame_4.lineWidth = 3;

		// preview_4
		this.add.image(241, 2268, "preview-flipping-the-bird");

		// bitmaptext_21
		const bitmaptext_21 = this.add.bitmapText(22, 2548, "nokia", "Roverkibb");
		...
		// bitmaptext_22
		const bitmaptext_22 = this.add.bitmapText(238, 2551, "nokia", "Level design:");
		...
		// bitmaptext_23
		const bitmaptext_23 = this.add.bitmapText(244, 2563, "nokia", "\"Berry Pie\"");
		...
		// frame_5
		const frame_5 = this.add.rectangle(241, 2468, 500, 134);
		frame_5.isStroked = true;
		frame_5.strokeColor = 5388102;
		frame_5.lineWidth = 3;

		// preview_5
		this.add.image(241, 2468, "preview-Roverkibb_Berry_Pie");

		// bitmaptext_24
		const bitmaptext_24 = this.add.bitmapText(22, 2750, "nokia", "Dungeonation");
		...
		// bitmaptext_25
		const bitmaptext_25 = this.add.bitmapText(310, 2753, "nokia", "Level design:");
		...
		// bitmaptext_26
		const bitmaptext_26 = this.add.bitmapText(316, 2765, "nokia", "\"Spirosenjo\"");
		...
		// frame_6
		const frame_6 = this.add.rectangle(241, 2670, 500, 134);
		frame_6.isStroked = true;
		frame_6.strokeColor = 5388102;
		frame_6.lineWidth = 3;

		// preview_6
		this.add.image(241, 2670, "preview-Spirosenjo");

		// bitmaptext_27
		const bitmaptext_27 = this.add.bitmapText(22, 2953, "nokia", "Koffy");
		...
		// bitmaptext_28
		const bitmaptext_28 = this.add.bitmapText(155, 2956, "nokia", "Level design:");
		...
		// bitmaptext_29
		const bitmaptext_29 = this.add.bitmapText(161, 2968, "nokia", "\"Heritage for The Past\"");
		...
		// frame_7
		const frame_7 = this.add.rectangle(241, 2873, 500, 134);
		frame_7.isStroked = true;
		frame_7.strokeColor = 5388102;
		frame_7.lineWidth = 3;

		// preview_7
		this.add.image(241, 2873, "preview-Koffy");
		...
		// parallax_Backing
		const parallax_Backing = this.add.image(-30, 3366, "Parallax-Backing_1");
		parallax_Backing.scaleX = 2.2;
		parallax_Backing.setOrigin(0, 0);
		parallax_Backing.flipY = true;

		// rectangle_3
		const rectangle_3 = this.add.rectangle(-30, 3242, 550, 300);
		rectangle_3.setOrigin(0, 0);
		rectangle_3.isFilled = true;
		rectangle_3.fillColor = 16753024;

		// paralax_Mountains
		this.add.image(128, 3577, "Paralax-Mountains");

		// paralax_Mountains_1
		this.add.image(448, 3577, "Paralax-Mountains");

		// gappyText
		const gappyText = this.add.bitmapText(79, 3035, "nokia", "Gappy (Gappy series) by LeviRamirez");
		...
		// gappyIcon
		const gappyIcon = this.add.image(42, 3038, "gappy", "airborne/00");
		gappyIcon.scaleX = 2;
		gappyIcon.scaleY = 2;

		// puckText
		const puckText = this.add.bitmapText(79, 3083, "nokia", "Puck (Pucamuc) by Mors");
		...
		// puckIcon
		const puckIcon = this.add.image(42, 3086, "pucamuc", "run/03");
		puckIcon.scaleX = 2;
		puckIcon.scaleY = 2;

		// kidText
		const kidText = this.add.bitmapText(79, 3134, "nokia", "The Kid (I Wanna Be The Guy) by Kayin");
		...
		// kidIcon
		const kidIcon = this.add.image(42, 3137, "kid", "flap/02");
		kidIcon.scaleX = 2;
		kidIcon.scaleY = 2;

		// bitmaptext_38
		const bitmaptext_38 = this.add.bitmapText(240, 3487, "nokia", "Thanks for playing!");
		...
		// rectangle_4
		const rectangle_4 = this.add.rectangle(0, 3382, 480, 260);
		...
		// plane_1
		const plane_1 = this.add.image(62, 3476, "plane_1");
		plane_1.flipX = true;

		// soldiermid_1
		const soldiermid_1 = this.add.image(398, 3480, "soldiermid_1");
		soldiermid_1.setOrigin(0, 0);
		soldiermid_1.flipX = true;

		// soldieronballoon_1
		const soldieronballoon_1 = this.add.image(404, 3485, "soldieronballoon_1");
		soldieronballoon_1.setOrigin(0, 0);
		soldieronballoon_1.flipX = true;

		// bitmaptext_42
		const bitmaptext_42 = this.add.bitmapText(240, 3623, "nokia", "Click / tap to return");
		...
		// bitmaptext_39
		const bitmaptext_39 = this.add.bitmapText(334, 1724, "nokia", "\"Castlevanioid\"\n\"I Wanna Save The Kids\"");
		...
		// kidText_1
		const kidText_1 = this.add.bitmapText(240, 3316, "nokia", "Powered by");
		...
		const phaser_pixel_medium_shaded = this.add.image(240, 3342, "phaser-pixel-medium-shaded");
		phaser_pixel_medium_shaded.setOrigin(0.5, 0);

		// kidText_2
		const kidText_2 = this.add.bitmapText(240, 3233, "nokia", "Phaser Editor v3");
		...
		// kidText_3
		const kidText_3 = this.add.bitmapText(240, 3255, "nokia", "Tiled level editor");
		...
		// kidText_4
		const kidText_4 = this.add.bitmapText(240, 3209, "nokia", "Software:");
